  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "note_length_strict_ws": parse_note_length_strict_ws,
      ...
      function parse_header() {
        ...
        pos0 = pos;
        pos1 = pos;
        result0 = parse_abc_version();
        result0 = result0 !== null ? result0 : "";
        if (result0 !== null) {
          result1 = parse_reference_number();
        ...
        if (result0 !== null) {
          result0 = (function(offset, version, refnum, title, pairs, k) {
            var p = {
      ...
      function parse_abc_version() {
        var result0, result1, result2, result3, result4, result5, result6, result7;
        var pos0, pos1;
        
        pos0 = pos;
        pos1 = pos;
        if (input.substr(pos, 5) === "%abc-") {
          result0 = "%abc-";
          pos += 5;
        } else {
          result0 = null;
        ...
        if (result0 !== null) {
          result0 = (function(offset, major, minor) { return { major: major, minor: minor } })(pos0, result0[2], result0[6]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_tempo() {
        ...
        pos1 = pos;
        result0 = [];
        result1 = parse_note_length_strict_ws();
        while (result1 !== null) {
        ...
        if (result0 !== null) {
          result0 = (function(offset, l, b) { if(!l.length) l = "1/4"; return { "note_length": l, "bpm": b } })(pos0, result0[0], result0[2]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_note_length_strict_ws() {
        var result0, result1, result2, result3;
        var pos0, pos1, pos2;
        ...
        if (result0 !== null) {
          result0 = (function(offset, l) { return l.join("") })(pos0, result0[0]);
        }
        if (result0 === null) {
          pos = pos0;
        }
